...
explore: ga4_data {
  hidden: yes
    join: ga4_data__items {
      view_label: "Ga4 Data: Items"
      sql: LEFT JOIN UNNEST(${ga4_data.items}) as ga4_data__items ;;
      relationship: one_to_many
    }
    join: ga4_data__event_params {
      view_label: "Ga4 Data: Event Params"
      sql: LEFT JOIN UNNEST(${ga4_data.event_params}) as ga4_data__event_params ;;
      relationship: one_to_many
    }
    join: ga4_data__user_properties {
      view_label: "Ga4 Data: User Properties"
      sql: LEFT JOIN UNNEST(${ga4_data.user_properties}) as ga4_data__user_properties ;;
      relationship: one_to_many
    }
}
# The name of this view in Looker is "Ga4 Data"
view: ga4_data {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `bytecodeio-datablocks.google_analytics.ga4_data` ;;
...
# The name of this view in Looker is "Ga4 Data Items"
view: ga4_data__items {
...
# The name of this view in Looker is "Ga4 Data Event Params"
view: ga4_data__event_params {
  ...
  dimension: ga4_data__event_params {
    type: string
    hidden: yes
    sql: ga4_data__event_params ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
...
# The name of this view in Looker is "Ga4 Data User Properties"
view: ga4_data__user_properties {
  ...
  dimension: ga4_data__user_properties {
    type: string
    hidden: yes
    sql: ga4_data__user_properties ;;
  }
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Key" in Explore.
